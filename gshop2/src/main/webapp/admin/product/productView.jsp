			    	...
			    	<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#productInfo">
			      		<div class="card-body">
							...
							<div class="form-row align-items-center">
								...
								<div class="col-10 subContent">
									<img style="width:300px; height:300px;"src="/storage/showProduct.do?product_name_image=${productDTO.product_name_image}">
								</div>				
							</div>
							<hr class="sub-hr">
							<div class="form-row align-items-center">
...
<script type="text/javascript" src="/resources/custom/js/adminProduct/productView.js"></script>
