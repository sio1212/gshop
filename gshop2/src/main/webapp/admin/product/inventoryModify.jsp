...
<link rel="stylesheet" href="/resources/custom/css/adminProduct.css">
	<!--CSS Local LINK:END-->
...
<script type="text/javascript" src="/resources/custom/js/adminProduct/admin.inventory.js"></script>
