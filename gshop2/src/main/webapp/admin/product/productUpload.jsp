...
<link rel="stylesheet" href="/minishop/resources/custom/css/userproduct.css">
	...
	<h2 style="text-align: center; letter-spacing: 2pt; font-weight: 5px;">상품 등록</h2>	
<div class="col-lg-8" style="border-style: double;">

	<form id="uploadForm" method="post" enctype="multipart/form-data" action="/admin/product/doUpload.do">
		...
		<div class="create_product">
				<input type="button" class="searchBtn" value="상품 등록" id="productUploadBtn">
				<input type="button" id="uploadReset" class="searchBtn" value="다시작성">
				<input type="button" id="productReturn" class="searchBtn" value="뒤로가기">										    									
		</div>	
...
<script type="text/javascript" src="/resources/custom/js/general/ckeditor4Admin.js"></script>
<script type="text/javascript" src="/resources/custom/js/adminProduct/admin.product.js"></script>
<script type="text/javascript" src="/resources/custom/js/adminProduct/productUpload.js"></script>
