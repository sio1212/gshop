...
<div class="col-lg-8">
	...
	<form id="modifyForm" method="post" enctype="multipart/form-data" action="/admin/product/productModify.do">
...
<script type="text/javascript" src="/resources/custom/js/adminProduct/productModifyForm.js"></script>
