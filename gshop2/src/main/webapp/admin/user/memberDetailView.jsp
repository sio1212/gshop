...
<link rel="stylesheet" type="text/css" href="/resources/custom/css/member.css">
...
<script type="text/javascript" src="/resources/custom/js/adminUser/memberDetailView.js"></script>
