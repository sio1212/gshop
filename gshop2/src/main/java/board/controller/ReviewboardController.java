...
public class ReviewboardController {
	...
	throws Exception
	{
		...
		Map<String,Object> data = new HashMap<String,Object>();
	        ...
	        try {
				...
				//(3) 미리보기 화면용 업로드
				Localpath="D:\\workspace\\springboard\\gshop2\\src\\main\\webapp\\storage\\review";
			try {
	...
	public ModelAndView reviewView(@RequestParam(required=false,defaultValue="1") String pg,String review_seq, String productid, HttpSession Session,HttpServletRequest request,HttpServletResponse response) {
